...
describe('StoryCard', () => {
  ...
  // Random Treasure button tests
  it('renders Random Treasure button', () => {
    render(<StoryCard {...defaultProps} />);
  ...
  it('calls onRandomHistory when button clicked', () => {
    ...
    fireEvent.click(screen.getByText('Random Treasure'));
  ...
  // Audio controls — no audio state (auto-generating, only Random Treasure visible)
